			...
			textobjects = {
				select = {
					...
					keymaps = {
						...
						["a:"] = { query = "@property.outer", desc = "Select around an object property" },
						["i:"] = { query = "@property.inner", desc = "Select inside an object property" },
						["l:"] = { query = "@property.lhs", desc = "Select left part of an object property" },
						["r:"] = { query = "@property.rhs", desc = "Select right part of an object property" },

						["aa"] = { query = "@parameter.outer", desc = "Select around a parameter/argument" },
						["ia"] = { query = "@parameter.inner", desc = "Select inside a parameter/argument" },
						...
						["af"] = { query = "@call.outer", desc = "Select around a function call" },
						["if"] = { query = "@call.inner", desc = "Select inside a function call" },
