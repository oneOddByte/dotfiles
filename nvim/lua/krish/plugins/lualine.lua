return {
	...
	config = function()
		...
		local function get_hl_color(hl, attr, fallback)
		...
		-- Build a lualine theme from current colorscheme
		local function build_theme()
			local colors = {
				bg = get_hl_color("Normal", "background", "#1e1e2e"),
				fg = get_hl_color("Normal", "foreground", "#c0caf5"),
				blue = get_hl_color("Function", "foreground", "#7aa2f7"),
				green = get_hl_color("String", "foreground", "#9ece6a"),
				red = get_hl_color("Error", "foreground", "#f7768e"),
				yellow = get_hl_color("WarningMsg", "foreground", "#e0af68"),
				magenta = get_hl_color("PreProc", "foreground", "#bb9af7"),
				cyan = get_hl_color("Special", "foreground", "#2ac3de"),
				inactive_bg = get_hl_color("NonText", "background", "#2e2e3e"),
			}
		...
		-- Reload theme on colorscheme change
